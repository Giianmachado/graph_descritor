#############################################################################
# Makefile for building: graph_descritor
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  graph_descritor.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile graph_descritor.pro
#############################################################################
...
LIBS += `pkg-config --libs --cflags igraph`
AR            = ar cqs
RANLIB        = 
...
SOURCES       = divider_and_computer.cpp \
		...
		utils.cpp \
		writefile.cpp 
OBJECTS       = divider_and_computer.o \
		graph.o \
		main.o \
		readfile.o \
		utils.o \
...
Makefile: graph_descritor.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile graph_descritor.pro
...
dist: 
	@test -d .tmp/graph_descritor1.0.0 || mkdir -p .tmp/graph_descritor1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/graph_descritor1.0.0/ && $(COPY_FILE) --parents divider_and_computer.h graph.h readfile.h utils.h writefile.h .tmp/graph_descritor1.0.0/ && $(COPY_FILE) --parents divider_and_computer.cpp graph.cpp main.cpp readfile.cpp utils.cpp writefile.cpp .tmp/graph_descritor1.0.0/ && (cd `dirname .tmp/graph_descritor1.0.0` && $(TAR) graph_descritor1.0.0.tar graph_descritor1.0.0 && $(COMPRESS) graph_descritor1.0.0.tar) && $(MOVE) `dirname .tmp/graph_descritor1.0.0`/graph_descritor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/graph_descritor1.0.0
...
divider_and_computer.o: divider_and_computer.cpp divider_and_computer.h \
		utils.h \
		graph.h \
		writefile.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o divider_and_computer.o divider_and_computer.cpp
...
main.o: main.cpp divider_and_computer.h \
		utils.h \
		writefile.h \
		readfile.h
